...
if(isset($submit))
{
	$rs=mysql_query("select * from srdc_user where login='$loginid' and pass='$pass'");
...
{
echo "<h2 style='color:green; font-weight:bold; font-size:26px;' align=center>Welcome to Online Student Survey</h2>";
		echo '<table width="28%"  border="0" align="center">
  <tr>
    <td width="30%" height="65" valign="bottom"></td>
    <td valign="bottom" bordercolor="#0000FF"> <a href="sublist.php" class="style4">Click here for Survey</a></td>
  </tr>
